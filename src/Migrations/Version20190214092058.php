 ...
 */
final class Version20190214092058 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contact CHANGE message message VARCHAR(2500) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contact CHANGE message message VARCHAR(1500) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
